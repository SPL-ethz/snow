...
mylambda = (
    0.8 * 0.05
)  # W/[mK] thermal conductivity of glass / times 0.1 to take into account that the actual contact area is smaller
...
sigma_solid = (
    sigma_equivalent * cp_w / cp_i
)  # similar temperature rise for a frozen sample, i.e. with solid heat capacity
